...
def distillation_loss(student_logits, teacher_logits, targets, alpha=1.0, beta=0.5):
    ...
    return alpha * (bce + dice) + beta * distill


def main():
    config_path = "configs/student_base16.yaml"
